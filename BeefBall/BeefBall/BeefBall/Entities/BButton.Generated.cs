...
namespace BeefBall.Entities
{
    public partial class BButton : PositionedObject, IDestroyable, IVisible, IWindow, IClickable
    {
        ...
        public BButton(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public BButton(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
        ...
        public virtual void Destroy()
        {
            ...
            {
                XBoxBButton.Detach();
                SpriteManager.RemoveSprite(XBoxBButton);
            }
