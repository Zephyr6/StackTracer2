...
namespace BeefBall.Entities
{
    public partial class Button : PositionedObject, IDestroyable, IVisible, IWindow
    {
        ...
        public Button(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public Button(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
