...
namespace BeefBall.Entities
{
    public partial class CapacitorPlatform : PositionedObject, IDestroyable
    {
        ...
        public CapacitorPlatform(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public CapacitorPlatform(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
