...
{
    public partial class CapacitorPlatformCopyCopy : PositionedObject, IDestroyable
    {
        ...
        private static Scene SceneFile2;
        ...
        public CapacitorPlatformCopyCopy(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public CapacitorPlatformCopyCopy(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
    ...
    // Extra classes
    public static class CapacitorPlatformCopyCopyExtensionMethods
    {
    }
}