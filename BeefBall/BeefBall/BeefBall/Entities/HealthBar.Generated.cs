...
namespace BeefBall.Entities
{
    public partial class HealthBar : PositionedObject, IDestroyable
    {
        ...
        public HealthBar(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public HealthBar(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
        ...
        public virtual void Destroy()
        {
            ...
            {
                FrameSprite.Detach();
                SpriteManager.RemoveSprite(FrameSprite);
            }
            if (BarSprite != null)
            {
                BarSprite.Detach();
                SpriteManager.RemoveSprite(BarSprite);
            }
            if (BorderSprite != null)
            {
                BorderSprite.Detach();
                SpriteManager.RemoveSprite(BorderSprite);
            }
