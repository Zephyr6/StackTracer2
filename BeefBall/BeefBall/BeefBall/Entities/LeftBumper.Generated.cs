...
namespace BeefBall.Entities
{
	public partial class LeftBumper : PositionedObject, IDestroyable, IVisible, IWindow
	{
        ...
        public LeftBumper(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public LeftBumper(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public virtual void Destroy()
		{
			...
			{
				LeftBumperButton.Detach(); SpriteManager.RemoveSprite(LeftBumperButton);
			}
