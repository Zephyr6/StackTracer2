...
namespace BeefBall.Entities
{
    public partial class ResistorStamp : PositionedObject, IDestroyable
    {
        ...
        public float followAmount = 0.4f;
        public int Index { get; set; }
        public bool Used { get; set; }
        protected Layer LayerProvidedByContainer = null;

        public ResistorStamp(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public ResistorStamp(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
