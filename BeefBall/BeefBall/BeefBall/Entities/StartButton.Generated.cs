...
{
    public partial class StartButton : PositionedObject, IDestroyable, IVisible, IWindow
    {
        ...
        private static Scene StartButtonScene;
		
        private FlatRedBall.Sprite XBoxStartButton;
        ...
        public StartButton(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public StartButton(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
        ...
        public virtual void Destroy()
        {
            ...
            if (XBoxStartButton != null)
            {
                XBoxStartButton.Detach();
                SpriteManager.RemoveSprite(XBoxStartButton);
            }
        ...
        public virtual void PostInitialize()
        {
            ...
            if (XBoxStartButton.Parent == null)
            {
                XBoxStartButton.X = 120f;
            }
            else
            {
                XBoxStartButton.RelativeX = 120f;
            }
            if (XBoxStartButton.Parent == null)
            {
                XBoxStartButton.Y = 10f;
            }
            else
            {
                XBoxStartButton.RelativeY = 10f;
            }
            XBoxStartButton.ScaleX = 15f;
            XBoxStartButton.ScaleY = 15f;
            X = 0f;
            Y = 0f;
            Visible = true;
        ...
        public virtual void AddToManagersBottomUp(Layer layerToAddTo)
        {
            ...
            RotationY = 0;
            RotationZ = 0;
            SpriteManager.AddToLayer(XBoxStartButton, layerToAddTo);
            if (XBoxStartButton.Parent == null)
            {
                XBoxStartButton.X = 120f;
            }
        ...
        public virtual void ConvertToManuallyUpdated()
        {
            ...
            SpriteManager.ConvertToManuallyUpdated(XBoxStartButton);
        }
        ...
        public static void LoadStaticContent(string contentManagerName)
        {
            ...
            if (IsStaticContentLoaded == false)
            {
                ...
                if (!FlatRedBallServices.IsLoaded<Scene>(@"content/entities/startbutton/startbuttonscene.scnx", ContentManagerName))
                {
                    registerUnload = true;
                }
                StartButtonScene = FlatRedBallServices.Load<Scene>(@"content/entities/startbutton/startbuttonscene.scnx", ContentManagerName);
        ...
        public static void UnloadStaticContent()
        {
            ...
            if (StartButtonScene != null)
            {
                StartButtonScene.RemoveFromManagers(ContentManagerName != "Global");
                StartButtonScene = null;
            }
        }
        ...
        public static object GetStaticMember(string memberName)
        {
            switch(memberName)
            {
                case "StartButtonScene":
                    return StartButtonScene;
            }
            return null;
        }
        ...
        public virtual bool HasCursorOver(FlatRedBall.Gui.Cursor cursor)
        {
            ...
            if (cursor.IsOn3D(XBoxStartButton, LayerProvidedByContainer))
            {
                return true;
            }
            return false;
        ...
        public virtual void SetToIgnorePausing()
        {
            ...
            InstructionManager.IgnorePausingFor(XBoxStartButton);
        }
    }
