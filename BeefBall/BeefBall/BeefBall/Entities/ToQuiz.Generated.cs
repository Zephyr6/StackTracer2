...
namespace BeefBall.Entities
{
    public partial class ToQuiz : PositionedObject, IDestroyable
    {
        ...
        public ToQuiz(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public ToQuiz(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
        ...
        public virtual void Destroy()
        {
            ...
            if (InstructionText != null)
            {
                ...
                TextManager.RemoveText(InstructionText);
            }
