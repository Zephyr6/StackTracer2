...
namespace BeefBall.Entities
{
    public partial class XButton : PositionedObject, IDestroyable, IVisible, IWindow
    {
        ...
        public XButton(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public XButton(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
        ...
        public virtual void Destroy()
        {
            ...
            {
                XBoxXButton.Detach();
                SpriteManager.RemoveSprite(XBoxXButton);
            }
