...
namespace BeefBall.Entities
{
    public partial class YButton : PositionedObject, IDestroyable, IVisible, IWindow, IClickable
    {
        ...
        public YButton(string contentManagerName) : this(contentManagerName, true)
        {
        }

        public YButton(string contentManagerName, bool addToManagers) : base()
        {
            // Don't delete this:
        ...
        public virtual void Destroy()
        {
            ...
            {
                XBoxYButton.Detach();
                SpriteManager.RemoveSprite(XBoxYButton);
            }
