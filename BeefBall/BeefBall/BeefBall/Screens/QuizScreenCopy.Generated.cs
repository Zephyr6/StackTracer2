...
{
    public partial class QuizScreenCopy : Screen
    {
        // Generated Fields
        #if DEBUG
        ...
        private BeefBall.Entities.LeftBumper LeftBumperInstance;
        public event FlatRedBall.Gui.WindowEvent NextQuestionClick;

        public QuizScreenCopy() : base("QuizScreenCopy")
        {
        }
        ...
        public override void Initialize(bool addToManagers)
        {
            ...
            LeftBumperInstance = new BeefBall.Entities.LeftBumper(ContentManagerName, false);
            LeftBumperInstance.Name = "LeftBumperInstance";
        ...
        public override void Destroy()
        {
            ...
            if (LeftBumperInstance != null)
            {
                LeftBumperInstance.Destroy();
                LeftBumperInstance.Detach();
            }
        ...
        public virtual void PostInitialize()
        {
            ...
            if (LeftBumperInstance.Parent == null)
            {
                LeftBumperInstance.X = -160f;
            }
            else
            {
                LeftBumperInstance.RelativeX = -160f;
            }
            if (LeftBumperInstance.Parent == null)
            {
                LeftBumperInstance.Y = 130f;
            }
            else
            {
                LeftBumperInstance.RelativeY = 130f;
            }
            LeftBumperInstance.LeftBumperButtonScaleX = 40f;
            LeftBumperInstance.LeftBumperButtonScaleY = 20f;
        ...
        public virtual void AddToManagersBottomUp()
        {
            ...
            StartButtonInst.Visible = false;
            LeftBumperInstance.AddToManagers(mLayer);
            if (LeftBumperInstance.Parent == null)
            {
                LeftBumperInstance.X = -160f;
            }
        ...
        public virtual void ConvertToManuallyUpdated()
        {
            ...
            LeftBumperInstance.ConvertToManuallyUpdated();
        }
        ...
        public static void LoadStaticContent(string contentManagerName)
        {
            ...
            BeefBall.Entities.LeftBumper.LoadStaticContent(contentManagerName);
